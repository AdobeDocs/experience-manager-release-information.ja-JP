...
| アイテム | 詳細 |
|--------|-----|
| 定義 | <ul> <li>機能パックはアドオン機能で、サービスパックを通じて提供されます。 次の場合： [!DNL Experience Manager] バージョンは最新のサービスパックをリリースしました。Adobeは今後、その機能パックを提供しません。 </li> <li> 機能パックには、製品の機能強化が含まれます。以降の製品リリースで予定されているが、[!DNL Adobe's] の製品管理部門の決定に基づいて予定より早く提供されます。</li> <li>  機能は、次のメジャーリリースで常に統合されます。 その後、それらは [!DNL Experience Manager] お客様が必要とするバージョン </li> <li>  Common Interest 機能パックと GA 機能パックは次のサービスパックに統合されます。  </li> </ul> |
