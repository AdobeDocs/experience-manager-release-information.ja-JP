...
| 項目 | 説明 |
|-----|-----|
| 定義 | <ul> <li> 予定されたリリース </li> <li> 現在は、ロールバックできません </li> </ul> |
...
| アイテム | 詳細 |
|--------|-----|
| 定義 | <ul> <li>機能パックはアドオン機能で、サービスパックを通じて提供されます。 [!DNL Experience Manager] バージョンが最後のサービスパックをリリースした場合、Adobeは今後、そのバージョンの機能パックを配信しません。 </li> <li> 機能パックには、製品の機能強化が含まれます。以降の製品リリースで予定されているが、[!DNL Adobe's] の製品管理部門の決定に基づいて予定より早く提供されます。</li> <li>  機能は、次のメジャーリリースで常に統合されます。 その後、顧客に必要な [!DNL Experience Manager] バージョンに移植されます </li> <li>  Common Interest 機能パックと GA 機能パックは次のサービスパックに統合されます。  </li> </ul> |
...
* 1：Oak の修正は、個別のホットフィックスとしては提供されません。ただし、その後の累積 Oak ホットフィックスには含まれます。必要に応じて、最新の COFP に基づいて構築された診断を公開できます。最新の COFP が動作していることが前提条件です。診断ビルドは、ホットフィックスと同じレベルの品質保証のみを提供します。 したがって、累積修正パック、サービスパック、または製品リリースほどの品質保証を提供するものではありません。最終的な修正は、次の CFP で提供されます。
