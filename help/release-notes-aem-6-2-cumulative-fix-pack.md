...
CFP および他のタイプのリリースの詳細については、[メンテナンスリリースの提供](https://docs.adobe.com/content/docs/ja-JP/aem/6-2/deploy/maintenance-release-vehicle-definitions.html)を参照してください。
...
[ファイルを取得
](assets/do-not-localize/osgi_bundle_list_for_aem-6.2sp1-cfp3.txt)累積修正パック 2 の主な特徴は次のとおりです。
...
>
>検証オプションのドキュメントは、[https://docs.adobe.com/content/docs/ja-JP/aem/6-2/administer/content/package-manager.html#Package%20Validator](https://docs.adobe.com/content/docs/ja-JP/aem/6-2/administer/content/package-manager.html#Package%20Validator) を参照してください。
...
* **コンポーネントインスタンス作成**&#x200B;および&#x200B;**サービスファクトリが NULL を返しました**&#x200B;エラーが、リポジトリーの再起動が原因で発生しました：

   * com.day.cq.cq-personalization [com.day.cq.personalization.impl.DefaultProfileProvider(938)] 参照 profileManager のバインドに失敗するため、コンポーネントインスタンスを作成できません。
   * org.apache.sling.commons.scheduler FrameworkEvent ERROR （org.osgi.framework.ServiceException：サービスファクトリは null を返しました。（コンポーネント：com.day.cq.taging.impl.TagGarbageCollector (1687)）
...
[AEM 6.2 SP1 の既知の問題のリスト](https://docs.adobe.com/docs/ja-JP/aem/6-2/release-notes/sp1.html#Known Issues)を参照してください。
...
>* [AEM 6.2 SP1 リリースノート](https://docs.adobe.com/content/docs/ja-JP/aem/6-2/release-notes/sp1.html)
...
>* [Adobe Priority 製品アップデート](https://docs.adobe.com/content/help/jp/release-notes/experience-cloud/current.html)の[サブスクリプション](https://campaign.adobe.com/webApp/adbePriorityProductSubscribe)を購入する
